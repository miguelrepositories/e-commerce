...
CREATE TABLE `security_data` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  KEY `security_personal_data` (`personal_id`),
  CONSTRAINT `security_personal_data` FOREIGN KEY (`personal_id`) REFERENCES `personal_data` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `security_data` VALUES (1,'D@n34518420',1);
...
-- Dump completed on 2025-01-04 13:07:07
